...
20 dB. The fixture uses full upstream suppression; the reference tests apply
NoiseHoiHoi's fixed 12 dB attenuation limit to both the expected and actual
signals. The official model archive SHA-256 is
